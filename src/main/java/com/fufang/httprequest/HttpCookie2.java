...
public class HttpCookie2 {
    ...
    public static String httpGetCookie(String loginUrl, String userName, String pwd) throws URISyntaxException, ClientProtocolException, IOException{  
	...
	public static void main(String[] args) throws ClientProtocolException, URISyntaxException, IOException {  
        ...
        HttpCookie2.httpGetCookie(Loginurl,user,pwd);
	}
}
