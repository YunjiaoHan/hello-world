...
public class PostPosition {
	...
	@Test
	public void postPosition() throws IOException, URISyntaxException{
		System.out.println("------start postPosition------");
		int id;
		String cookie = getCookie();
		String url = "http://172.16.88.183:9999/organization-manager/orgManager/postPosition.do";
		List<NameValuePair> nvps = new ArrayList<NameValuePair>();  
		nvps.add(new BasicNameValuePair("positionStr", "{\"position\":{\"name\":\"delete\",\"status\":0,\"code\":\"delete\",\"remark\":\"系统自动生成的岗位delete\"}}"));
		...
		try {  
			...
			if(postResponse.getStatusLine().getStatusCode() == 200){  
				...
				System.out.println("postPostion - " + postResult); 
				...
				String deleteUrl = "http://172.16.88.183:9999/organization-manager/orgManager/deletePosition.do?id="+id;
				...
				try{
					...
					System.out.println("deletePostion - " + getResult);
