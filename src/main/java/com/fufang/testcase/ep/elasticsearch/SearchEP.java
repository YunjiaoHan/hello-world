...
public class SearchEP{
	...
	public void searchName() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=复方&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		...
		for (int i = 0; i < hitsArray.size(); i++) {  			
			...
			//校验名称匹配
			boolean nameMatch = name.contains("复方");
	...
	public void searchLicense() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=国药准字H&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		String result = HttpGetUtils.httpGetUtils(url);
	...
	public void searchManuf() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=北京&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		String result = HttpGetUtils.httpGetUtils(url);
		...
		for (int i = 0; i < hitsArray.size(); i++) {  			
			...
			//校验名称匹配
			boolean match = manuf.contains("北京");
			//System.out.println("NameMatch = "+nameMatch);
	...
	public void searchSupplier() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=新购物车&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		String result = HttpGetUtils.httpGetUtils(url);
		...
		for (int i = 0; i < hitsArray.size(); i++) {  			
			...
			//校验名称匹配
			boolean match = supplier.contains("新购物车");
			//System.out.println("NameMatch = "+nameMatch);
	...
	@Test
	public void searchNameSpec() throws ClientProtocolException, IOException{
		System.out.println("------开始执行SearchNameSpec------");

		String url = "http://172.16.86.60:8080/api.search/ep?q=复方%20片&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		String result = HttpGetUtils.httpGetUtils(url);
		...
		for (int i = 0; i < hitsArray.size(); i++) {  			
			...
			String spec = JSONObject.fromObject(source).getString("spec");
			System.out.println("name/spec - " + name + "/" + spec);
			...
			//校验名称匹配
			boolean matchName = name.contains("复方");
			boolean matchSpec = spec.contains("片");
			//System.out.println("NameMatch = "+nameMatch);
			Assert.assertTrue(matchName, "name不匹配");
			Assert.assertTrue(matchSpec, "spec不匹配");
		}
	}
	...
	public void searchLicenseDosage() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=国药%20丸&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		String result = HttpGetUtils.httpGetUtils(url);
	...
	public void searchNameManuf() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=片%20山东&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		String result = HttpGetUtils.httpGetUtils(url);
	...
	public void searchLicenseManufDosage() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=国药%20山东%20片&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"; 
		String result = HttpGetUtils.httpGetUtils(url);
	...
	public void emptyParams() throws ClientProtocolException, IOException{
		...
		String result = HttpUtils.httpGetMethod2(url);
	...
	public static Object[][] invalidInput(){
		return new Object[][] { 
			{ "http://172.16.86.60:8080/api.search/ep?q=睇&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1"}, 
	...
	public void invalidParams() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=睇&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=1";
		String result = HttpGetUtils.httpGetUtils(url);
	...
	public void minScore() throws ClientProtocolException, IOException{
		...
		String url = "http://172.16.86.60:8080/api.search/ep?q=复方&page=1&pageSize=10&provinceId=110000&cityId=110100&minScore=3.4"; 
		String result = HttpGetUtils.httpGetUtils(url);
